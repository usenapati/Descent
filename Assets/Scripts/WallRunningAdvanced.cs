...
public class WallRunningAdvanced : MonoBehaviour
{
    ...
    private void CheckForWall()
    {
        ...
        Debug.DrawRay(transform.position, orientation.right, Color.red, 0.2f, false);
        Debug.DrawRay(transform.position, -orientation.right, Color.green, 0.2f, false);
    }
    ...
    private void StartWallRun()
    {
        ...
        if (wallLeft) cameraManager.DoTilt(-5f);
        if (wallRight) cameraManager.DoTilt(5f);
    }
